...
$route['getProductByGroup'] = 'Api/getProductByGroup';
$route['getPlansByProduct'] = 'Api/getPlansByProduct';
$route['getPldtPlanById'] = 'Api/getPldtPlanById';
$route['getDlByPlanId'] = 'Api/getDlByPlanId';
$route['getPldtPlan'] = 'Api/getPldtPlan';
$route['getAllPldtPlans'] = 'Api/getAllPldtPlans';
$route['getSmartTypeByProduct'] = 'Api/getSmartTypeByProduct';
$route['getSmartPlansType'] = 'Api/getSmartPlansType';
$route['getSmartPlanID'] = 'Api/getSmartPlanID';
$route['getAllSmartPlans'] = 'Api/getAllSmartPlans';


$route['insertPlanHits'] = 'Api/insertPlanHits';
$route['insertPlanCompare'] = 'Api/insertPlanCompare';
